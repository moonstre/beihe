            ...
            if (bean != null) {
                ...
                if (Constant.hideHomeNearAndNew()){
                     if (state==3){
                         ...
                         mHolder.mStatusTv.setVisibility(View.VISIBLE);
                         mHolder.mStatusTv.setCompoundDrawables(drawable, null, null, null);
                         mHolder.mStatusTv.setText(mContext.getString(R.string.service_ing));
                         mHolder.mStatusTv.setTextColor(mContext.getResources().getColor(R.color.gray_bcbcbc));
                    }
                }
                ...
                if (Constant.hideHomeNearAndNew()){
                    if (TextUtils.equals(bean.t_visit,"0")){
                        ...
                        mHolder.mGoHome.setText("可上门");
//                        mHolder.back_color.setVisibility(View.VISIBLE);
                        mHolder.back_color.setBackgroundResource(R.drawable.tou_ming_background);
                    }else {
                        mHolder.mGoHome.setVisibility(View.GONE);
                        mHolder.back_color.setBackgroundResource(R.drawable.tou_ming_gree_background);
                    }
                }else {
                    mHolder.mGoHome.setVisibility(View.GONE);
                    mHolder.back_color.setBackgroundResource(R.drawable.tou_ming_gree_background);
    ...
    class TopHolder extends RecyclerView.ViewHolder {
        ...
        private void init(View itemView) {
            ...
            hot_tv=itemView.findViewById(R.id.hot_tv);
            if (Constant.hideHomeNearAndNew()){
                hot_tv.setVisibility(View.GONE);
            }else {
                mBannerRv.setVisibility(View.GONE);
            }
