...
public class ChargeDetailTwoFragment extends BaseCompactFragment {
    private int t_id;
    private UserCapitalRecyclerAdapter adapter;

    public ChargeDetailTwoFragment() {
    ...
    protected void onFirstVisible() {
        getShareUserCapitalRecord(t_id);
    }

    private void getShareUserCapitalRecord(int t_id) {
        Map<String, String> paramMap = new HashMap<>();
        paramMap.put("userId", String.valueOf(t_id));
        paramMap.put("type", "1");
        OkHttpUtils.post().url(ChatApi.GET_SHARE_USER_CAPITAL_RECORD)
