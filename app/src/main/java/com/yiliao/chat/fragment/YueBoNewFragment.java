...
public class YueBoNewFragment extends BaseFragment {
    public YueBoNewFragment(){}
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        ...
        mRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(@NonNull RefreshLayout refreshlayout) {
                getSortmmendList(refreshlayout, true, 1,1);
                getBannerList();
            }
        });
        mRefreshLayout.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(@NonNull RefreshLayout refreshlayout) {
                getSortmmendList(refreshlayout, false, mCurrentPage + 1,1);
                getBannerList();
            }
        });
    ...
    protected void onFirstVisible() {
        getSortmmendList(mRefreshLayout, true, 1,1);
        getBannerList();
    }
    /**
     * 获取banner
