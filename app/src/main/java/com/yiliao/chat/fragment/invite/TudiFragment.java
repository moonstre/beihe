...
import com.yiliao.chat.activity.ChargeDetailActivity;
...
public class TudiFragment extends BaseCompactFragment {
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(new OnItemClickListener<TudiBean>() {
            ...
            public void onItemClick(TudiBean bean, int position) {
                Intent intent = new Intent(mContext, ChargeDetailActivity.class);
                intent.putExtra(Constant.PASS_USER_ID, bean.t_id);
    ...
    private void getMyTudi(final RefreshLayout refreshlayout, final boolean isRefresh, int page) {
        ...
        paramMap.put("type", String.valueOf("1"));//1.一级推广用户 2.二级推广用户
