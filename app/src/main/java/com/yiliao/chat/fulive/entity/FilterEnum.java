...
public enum FilterEnum {
     ...
     * 滤镜资源
     */
    nature(Filter.Key.ORIGIN, R.mipmap.nature, R.string.origin),
    bailiang(Filter.Key.BAILIANG_2, R.mipmap.bailiang2, R.string.bailiang),
    fennen(Filter.Key.FENNEN_1, R.mipmap.fennen1, R.string.fennen),
    xiaoqingxin(Filter.Key.XIAOQINGXIN_6, R.mipmap.xiaoqingxin6, R.string.qingxin),
    lengsediao(Filter.Key.LENGSEDIAO_1, R.mipmap.lengsediao1, R.string.lengsediao),
    nuansediao(Filter.Key.NUANSEDIAO_1, R.mipmap.nuansediao1, R.string.nuansediao);
